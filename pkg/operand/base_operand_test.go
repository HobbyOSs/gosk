...
func TestBaseOperand_AddressingType(t *testing.T) {
	tests := []struct {
		...
		//{"Relative Offset", "LABEL", operand.CodeRelativeOffset},
		...
		//{"PTR [1234H]", "DWORD PTR [0x1234]", operand.CodeDirectAddress},
		//{"FAR PTR [5678H]", "FAR PTR [0x5678]", operand.CodeDirectAddress},
		{"DS:SI", "DS:SI", operand.CodeMemoryAddressX},
		{"DS:BX", "DS:BX", operand.CodeMemoryAddressX},
		{"ES:DI", "ES:DI", operand.CodeMemoryAddressY},
		{"ES:CX", "ES:CX", operand.CodeMemoryAddressY},
		//{"SHORT label", "SHORT label", operand.CodeRelativeOffset},
		//{"MOV AL, [0x1234]", "[0x1234]", operand.CodeModRMAddressMoffs},
		//{"MOV EAX, [0xABCD]", "[0xABCD]", operand.CodeModRMAddressMoffs},
		//{"MOV RAX, [0x1000]", "[0x1000]", operand.CodeModRMAddressMoffs},
	}
