...
func TestBaseOperand_OperandType(t *testing.T) {
	tests := []struct {
		...
		{"64-bit Register", "RAX", []OperandType{CodeR32}},
		...
		{"Control Register", "CR0", []OperandType{CodeK}},
		{"Control Register", "CR2", []OperandType{CodeK}},
		{"Control Register", "CR4", []OperandType{CodeK}},
		{"Debug Register", "DR0", []OperandType{CodeK}},
		{"Debug Register", "DR3", []OperandType{CodeK}},
		{"Debug Register", "DR7", []OperandType{CodeK}},
		{"Test Register", "TR3", []OperandType{CodeK}},
		{"Test Register", "TR5", []OperandType{CodeK}},
		{"Test Register", "TR6", []OperandType{CodeK}},
